...
class ScriptArguments:
    ...
    use_dp: Optional[bool] = field(default=False, metadata={"help": "Enable differential privacy for LoRA updates"})
    dp_epsilon: Optional[float] = field(default=2.0, metadata={"help": "Target epsilon for differential privacy"})
    dp_delta: Optional[float] = field(default=1e-5, metadata={"help": "Target delta for differential privacy"})
    dp_clip_norm: Optional[float] = field(default=1.0, metadata={"help": "Clipping threshold (sensitivity) for DP"})
